$Id: README 78001 2013-12-02 08:24:53Z gcosmo $
 ...
 A- VISUALISATION
   ...
   in the main() function in SlacTut.cc.    
 ...
 C- HOW TO RUN
    ...
    - Execute SlacTut in the 'interactive mode' with visualization:
        % ./SlacTut
    ...
    - Execute SlacTut  in the 'batch' mode from macro files 
      (without visualization)
        % ./SlacTut run2.mac
        % ./SlacTut SlacTut.in > SlacTut.out
